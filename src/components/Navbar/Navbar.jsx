      ...
      <section className={nav.wrapper}>
        <div className={nav.head}>
          ...
          <div className={nav.showonsmscreen}>
            <div className={nav.right}>
              ...
              {open.clicked ? (
                <>
                  <div id={nav.rightNav} style={{ display: "flex" }}>
                    <div className={nav.item} style={{ position: "relative" }}>
                      ...
                      >
                        <i id={nav.bar} className={"fas fa-times"}></i>
                      </div>
                    </div>
                    <div className={nav.item}>
                      <a
        ...
        <section className={nav.bottom}>
          <div className={nav.bottomRight}>
            <h1 className="	">
              Get equipped to{" "}
              <span className={nav.span}> take over the world</span>
            </h1>
            <p className={nav.bottompara}>
              Reach your dreams through Discovering and Exploring your
              potentials. Lorem ipsum dolor sit amet, consecteur adipiscing
